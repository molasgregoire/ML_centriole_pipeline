...
# class
class Pixel14_42(torch.nn.Module):
    def __init__(self):
...
class Pixel14_84(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
class Pixel14_126(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
class Pixel14_168(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
class Pixel14_210(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
class Pixel14_252(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
models_to_test = [ 
    Pixel14_42().to(device),
    Pixel14_84().to(device),
    Pixel14_126().to(device),
    Pixel14_168().to(device),
    Pixel14_210().to(device),
    Pixel14_252().to(device)]
...
for hl in range(len(models_to_test)):
    # list of models
    models_optis  = []
    for i in range(n_cv):
        model =  models_to_test[hl].copy()
...
plt.title( 'Cross Validation Losses : Hidden Layer Size'  )
...
plt.xticks( [  0.25 ,1.25,2.25,3.25,4.25,5.25 ] , ['42','84','126','168','210','252'] )
...
plt.title( 'Cross Validation F1 : Hidden Layer Size'  )
...
plt.title( 'Cross Validation Precision : Hidden Layer Size'  )
...
plt.title( 'Cross Validation Recall : Hidden Layer Size'  )
