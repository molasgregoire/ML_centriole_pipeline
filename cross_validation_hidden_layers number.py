...
### OUR NEURAL NETWORK -> duplicate to have multiple hidden layer size

# device setting
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# class
class Pixel14_3(torch.nn.Module):
    def __init__(self):
...
# class
class Pixel14_4(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
# class
class Pixel14_5(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
# class
class Pixel14_6(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
# class
class Pixel14_7(torch.nn.Module):
    def __init__(self):
        """From: LeCun et al., 1998. Gradient-Based Learning Applied to Document Recognition"""
        super().__init__()
        self.conv1 = torch.nn.Conv2d(2, 21, kernel_size=2)
...
plt.title( 'Cross Validation Losses : Hidden Layers Number'  )
...
plt.xticks( [  0.25 ,1.25,2.25,3.25,4.25, ] , ['3','4','5','6','7'] )
...
plt.title( 'Cross Validation F1 : Hidden Layers Number'  )
...
plt.title( 'Cross Validation Precision : Hidden Layers Number'  )
...
plt.title( 'Cross Validation Recall : Hidden Layers Number'  )
